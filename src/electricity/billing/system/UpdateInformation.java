...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter){
        ...
        title.setBounds(110, 8, 400, 30);
        title.setFont(new Font("Sitka Small", Font.PLAIN, 20));
        add(title);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/updatepic.png"));
