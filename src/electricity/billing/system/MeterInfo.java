...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    MeterInfo(String meternumber){  
        ...
        super("User's  Meter Information");
        ...
        title.setBounds(180, 22, 400, 26);
        title.setFont(new Font("Sitka Small", Font.PLAIN, 24));
        p.add(title);
        
        l1 = new JLabel("Meter Number");
        l1.setBounds(100, 80, 100, 20);
        
        l11 = new JLabel(meternumber);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            String q1 = "insert into meter_info values('"+meter+"','"+meter_location+"','"+meter_type+"','"+phase_code+"','"+bill_type+"','"+days+"')";
            try{
                Conn c1 = new Conn();
